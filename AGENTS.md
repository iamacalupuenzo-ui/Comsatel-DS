...
- Import per component: `import { Button } from "@iamacalupuenzo-ui/comsatel-ds"` (the library's package name, not the workspace name `comsatel-ds-angular`).
...
- Importa desde `@iamacalupuenzo-ui/comsatel-ds`, nunca desde `projects/comsatel-ds/src/...`.
